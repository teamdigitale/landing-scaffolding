    ...
    <div id="comefunziona" className="row align-items-center">
      <div className="offset-lg-1 col-lg-5 mt-4 mt-lg-0">
        <div className="text-center text-lg-left">
          ...
          <HeroTitle title={title} linkTo={benefitHero.linkTo} />
          <HeroBody html={body} />
        </div>
        <HeroCtaContainer>
          <Cta text={showSPID} linkTo={benefitHero.linkTo} aria-label={ctaAriaLabel} />
          <Cta text={showCIE} linkTo={benefitHero.linkTo} aria-label={ctaAriaLabel} />
        </HeroCtaContainer>
      </div>
